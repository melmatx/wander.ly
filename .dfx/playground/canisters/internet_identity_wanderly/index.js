...
import { idlFactory } from './internet_identity_wanderly.did.js';
export { idlFactory } from './internet_identity_wanderly.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.INTERNET_IDENTITY_WANDERLY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./internet_identity_wanderly.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the internet_identity_wanderly canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./internet_identity_wanderly.did.js")._SERVICE>}
 */
export const internet_identity_wanderly = createActor(canisterId);
